...
struct HamiltonFastMarching {
    ...
    //------------- arguments related to tubular structure construction----------//
    Array<ScalarType,Dimension> mask;
    Array<ScalarType,Dimension> tubularNeighbourhood;
    bool acuteAnglePreservedShape=false;
    ScalarType angleScalarProductTolerance=0.05;
    ScalarType minRadiusTolerance=4;
    std::vector<OffsetType>   neighbourOffsetList;
    Array<VectorType,Dimension> normalizedGeoFlows;
    bool IsInsideTubularNeighbourhood(IndexCRef);
    std::set<IndexType,typename IndexType::LexicographicCompare> listSeedIndices;
    //------------------------------------------------------//
