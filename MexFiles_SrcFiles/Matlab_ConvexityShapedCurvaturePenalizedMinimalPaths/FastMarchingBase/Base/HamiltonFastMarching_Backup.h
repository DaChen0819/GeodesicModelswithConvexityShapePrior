...
struct HamiltonFastMarching {
    ...
    Array<ScalarType,Dimension-1> physicalActiveRegion;
    Array<ScalarType,Dimension-1> scribbleRegion;
    Array<ScalarType,Dimension-1> taggedAdaptiveCutRegion;
    Array<ScalarType,Dimension>   totalCurvature;
    bool useSimplicity=true;
...
//protected:
    ...
    //---------------- used for circular geodesic detection --------------------------
    bool ConvexSimpleGeodesic(IndexType,VectorType&);
    bool AdaptiveCrossingDetection(IndexType,IndexType) const;
